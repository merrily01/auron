 ...
 * to Arrow data from Flink's columnar batch execution engine. {@link DateDayVector} stores dates
 * as epoch days ({@code int}), which maps directly to Flink's internal DATE representation.
 */
